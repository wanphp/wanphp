...
var Editor = /*#__PURE__*/function () {
  function Editor(context) {
    ...
    this.resize = this.wrapCommand(function (value) {
      ...
      if (value === 0) {
        $target.css({'max-width': '100%',height: '',width: ''});
      } else {
        $target.css({
          width: value * 100 + '%',
          height: '',
  ...
  Buttons_createClass(Buttons, [{
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.fontsize', function () {
        return _this2.ui.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.ui.dropdownButtonContents('<i class="note-current-fontsize"></i>', _this2.options),
      ...
      this.context.memo('button.fontsizeunit', function () {
        return _this2.ui.buttonGroup([_this2.button({
          className: 'dropdown-toggle',
          contents: _this2.ui.dropdownButtonContents('<i class="note-current-fontsizeunit"></i>', _this2.options),
...
var AirPopover = /*#__PURE__*/function () {
  ...
  AirPopover_createClass(AirPopover, [{
    ...
    value: function initialize() {
      ...
      var $content = this.$popover.find('.popover-body');
...
var HintPopover = /*#__PURE__*/function () {
  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function initialize() {
      ...
      this.$popover.hide();
      this.$content = this.$popover.find('.popover-body,.note-popover-content');
