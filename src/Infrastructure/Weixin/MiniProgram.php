...
class MiniProgram
{
  ...
  {
    //数据库取缓存
    $cachedata = $this->redis->get('miniProgram_jsonToken');
    ...
    if (isset($result['access_token'])) {
      ...
      $this->redis->setex('miniProgram_jsonToken', $expire, $token);
   ...
   * @throws \Exception
   */
  public function getFeedback(int $page, int $limit, int $type = 0)
  {
